...
enhanced_discriminator = EnhancedDiscriminator(
    in_channels=32,         # Input feature size (matches output of the encoder)
...
model = ARGVA(encoder, enhanced_discriminator).to(device)

# Optimizers
encoder_optimizer = torch.optim.Adam(encoder.parameters(), lr=0.001)
discriminator_optimizer = torch.optim.Adam(enhanced_discriminator.parameters(), lr=0.001)
