...
# from atom import GraphMultiComponentClassifier
from atom2 import GraphMultiComponentClassifier
...
parser.add_argument('--dataname', type=str, default='DD', help='DD/PROTEINS/NCI1/NCI109/Mutagenicity') # PROTEINS, COLLAB, DD, NCI1, NCI109, Mutagenicity
...
if __name__ == "__main__":
    ...
    setseed(args.seed)
    # model = Net(args)
    model = GraphMultiComponentClassifier(in_features=args.num_features, hidden_dim=64, num_classes= args.num_classes, num_clusters=5).to(args.device)
